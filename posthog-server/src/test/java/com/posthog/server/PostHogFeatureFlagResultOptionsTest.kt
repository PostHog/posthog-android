...
internal class PostHogFeatureFlagResultOptionsTest {
    ...
    fun `group method creates groups map when null`() {
        val builder = PostHogFeatureFlagResultOptions.builder()
    ...
    @Test
    fun `sendFeatureFlagEvent method sets value to true`() {
        val options =
            PostHogFeatureFlagResultOptions.builder()
                .sendFeatureFlagEvent(true)
                .build()

        assertEquals(true, options.sendFeatureFlagEvent)
    }

    @Test
    fun `sendFeatureFlagEvent method sets value to false`() {
        val options =
            PostHogFeatureFlagResultOptions.builder()
                .sendFeatureFlagEvent(false)
                .build()

        assertEquals(false, options.sendFeatureFlagEvent)
    }

    @Test
    fun `sendFeatureFlagEvent method sets value to null`() {
        val options =
            PostHogFeatureFlagResultOptions.builder()
                .sendFeatureFlagEvent(true)
    ...
    @Test
    fun `sendFeatureFlagEvent method returns builder for chaining`() {
        val builder = PostHogFeatureFlagResultOptions.builder()
        val result = builder.sendFeatureFlagEvent(true)
