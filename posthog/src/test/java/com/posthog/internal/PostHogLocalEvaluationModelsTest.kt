...
public class PostHogLocalEvaluationModelsTest {
    ...
    public fun testPropertyOperatorFromString() {
        ...
        assertEquals(PropertyOperator.STARTS_WITH, PropertyOperator.fromStringOrNull("starts_with"))
        assertEquals(PropertyOperator.NOT_STARTS_WITH, PropertyOperator.fromStringOrNull("not_starts_with"))
        assertEquals(PropertyOperator.ENDS_WITH, PropertyOperator.fromStringOrNull("ends_with"))
        assertEquals(PropertyOperator.NOT_ENDS_WITH, PropertyOperator.fromStringOrNull("not_ends_with"))
