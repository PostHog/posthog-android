...
internal class GsonPropertyOperatorAdapter :
    ...
    private fun PropertyOperator.toApiString(): String =
        when (this) {
            ...
            PropertyOperator.STARTS_WITH -> "starts_with"
            PropertyOperator.NOT_STARTS_WITH -> "not_starts_with"
            PropertyOperator.ENDS_WITH -> "ends_with"
            PropertyOperator.NOT_ENDS_WITH -> "not_ends_with"
