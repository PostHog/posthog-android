...
Add SDK-internal interaction invalidation and guarded enqueue APIs to prevent delayed detector events crossing identity, consent, navigation, session or close transitions, including changes from `beforeSend`. Ordinary capture behavior is unchanged.
